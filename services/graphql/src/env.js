...
module.exports = cleanEnv(process.env, {
  ...
  ONLINE_DIRECTORY_ALIAS: nonemptystr({ desc: 'The leadership section alias to be displayed', default: 'directory' }),
  ONLINE_DIRECTORY_MAX: num({ desc: 'The maximum number of directory sections that can be selected per site.', default: 3 }),
  ONLINE_DIRECTORY_PRIMARY_SITE_ONLY: bool({ desc: 'If directory sections should be limited to content primary site.', default: false }),
  ONLINE_DIRECTORY_SCHEDULED_SITE_ONLY: bool({ desc: 'If leadership sections should be limited sites that have schedules.', default: false }),
