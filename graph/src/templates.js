...
module.exports = {
  notifyTemplate: `${header} ${textP}A user has requested changes to a company or related content.</p>${textP}To view these changes, please <a href="__uri__/cu/review/___id__">click here</a>.</p> ${footer}`,
